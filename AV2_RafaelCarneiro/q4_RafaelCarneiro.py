...
#=================================================================================================================================================
    ...
    USERS = lambda: ("USERS", "u", ["id", "name", "country", "id_console"])
    VIDEOGAMES = lambda: ("VIDEOGAMES", "v", ["id_console", "name", "id_company", "release_date"])

    # Gerar INNER JOIN entre USERS e VIDEOGAMES nas colunas em comum
    inner_join_users_videogames = lambda: gen_inner_join(USERS(), VIDEOGAMES())
