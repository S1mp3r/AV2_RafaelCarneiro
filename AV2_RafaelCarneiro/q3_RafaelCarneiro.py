...
# #Inserir aqui o Banco de Dados funcional
...
# sql = "INSERT INTO USERS (id, name, country, id_console) VALUES (%s, %s, %s);"
# val = ("John", "USA", '1')
# mycursor.execute(sql, val)

# sql = "DELETE FROM USERS WHERE %s = %s;"
# val = ('id', '1')
# mycursor.execute(sql, val)
...
# sql = "INSERT INTO VIDEOGAMES (name, id_company, release_date) VALUES (%s, %s, %s);"
# val = ("Game Console X", "1", "2023-01-15")
# mycursor.execute(sql, val)

# sql = "DELETE FROM VIDEOGAMES WHERE id_console = %s;"
# val = ('1',)  
# mycursor.execute(sql, val)
...
# val = ("Game Title A", "Action", "2023-02-20", "1")
# mycursor.execute(sql, val)


# sql = "DELETE FROM GAMES WHERE id_game = %s;"
# val = ('1',)
# mycursor.execute(sql, val)
...
# val = ("Game Company A", "USA")
# mycursor.execute(sql, val)


# sql = "DELETE FROM COMPANY WHERE id_company = %s;"
# val = ('1',)
# mycursor.execute(sql, val)
